// Avalehe sisu konfiguratsioon - muuda väärtusi siin
export const homeContent = {
  // Päise logod
  logos: {
    left: "/images/tla-logo.png",
    center: "/images/eka-logo.png",
    right: "/images/ekm-logo.png",
  },

  // Pealkiri ja alapealkiri
  title: "TSUNFTIMEISTRID",
  subtitle: "Eesti käsitöötsunftide meistrite, sellide ja õpipoiste andmebaas",

  // Otsinguväljad
  search: {
    namePlaceholder: "Johannes Hau",
    detailsPlaceholder: "detailotsing",
    buttonText: "Otsi",
  },
  ...
  contact: {
    title: "KONTAKT",
    name: "Triin Kröönström",
    organization: "Tallinna Linnaarhiiv",
    email: "triin.kroonstrom@tallinnlv.ee",
  },
